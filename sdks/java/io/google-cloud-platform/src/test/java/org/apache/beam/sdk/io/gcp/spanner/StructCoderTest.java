...
public class StructCoderTest {
  ...
  public void primitiveValues() throws Exception {
    verifyCoder(
        Struct.newBuilder()
            ...
            .to("StringValue")
            .set("byte")
            .to(ByteArray.copyFrom(new byte[] {1, 2, 3, 4, 5}))
            .set("timestamp")
            .to(Timestamp.MIN_VALUE)
            .set("date")
            .to(Date.fromYearMonthDay(2017, 12, 12))
            .build());
  }
  ...
  public void arrayValues() throws Exception {
    verifyCoder(
        Struct.newBuilder()
            .set("bools")
            .toBoolArray(Arrays.asList(true, null, false, null, true))
            .set("ints")
            .toInt64Array(Arrays.asList(1L, 2L, null, 4L))
            .set("floats")
            .toFloat64Array(Arrays.asList(1.1, null, 2.2, null, 4.5))
            .set("strings")
            .toStringArray(Arrays.asList(null, "one", "five", null))
            .set("bytes")
            .toBytesArray(
            ...
            .set("dates")
            .toDateArray(Arrays.asList(Date.fromYearMonthDay(1, 1, 1), null))
            .build());
  }
